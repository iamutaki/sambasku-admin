...
import { Alert, App as AntdApp, Button, Flex, Input, Select, Tag, Typography } from 'antd';
      ...
      columnHelper.display({
        ...
        cell: (info) => (
          <Button
            type="link"
            onClick={() =>
              message.info(`Halaman detail kata "${info.row.original.lemma}" menyusul di fitur berikutnya`)
            }
          >
            Detail
          </Button>
